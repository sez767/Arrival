...
class FillPermissionsForArrival extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForArrival constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.arrival',
            'admin.arrival.index',
            'admin.arrival.create',
            'admin.arrival.show',
            'admin.arrival.edit',
            'admin.arrival.delete',
            'admin.arrival.bulk-delete',
        ]);
